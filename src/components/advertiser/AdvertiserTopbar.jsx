...
const AdvertiserTopbar = ({ toggleSidebar }) => {
    ...
    const getTitle = () => {
        const paths = {
            ...
            "/advertiser/advertisements": "Advertisements",
            "/advertiser/feedbacks": "Feedbacks",
        };
        return paths[location.pathname] || "Advertiser Panel";
    };
