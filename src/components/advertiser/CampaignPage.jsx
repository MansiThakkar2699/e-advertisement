...
import { Search, Eye, Trash2, CheckCircle, Loader2, Check, X, PauseCircle, XCircle, Clock, CheckCheck, FolderPlus, Edit2 } from 'lucide-react';
...
const CampaignPage = () => {
    ...
    const fetchCompaigns = async () => {
        try {
            ...
            const response = await axios.get(`/campaign/campaign/advertiser/${decoded.id}`, {
                headers: {
    ...
    const columns = [
        {
            key: 'name', label: 'Campaign Name', sortable: true, render: (_, campaign) => (
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
                ...
                <div className="flex gap-3">
                    <button onClick={() => setOpenAddModal(true)}
                        ...
                        <FolderPlus className="w-4 h-4" /> Add New Campaign
                    </button>
                </div>
            </div>
